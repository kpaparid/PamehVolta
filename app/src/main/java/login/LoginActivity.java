...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String LOGIN_URL = "http://pamevolta.hol.es/login.php" ;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.tUserName);
        ...
        fb.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                LoginManager.getInstance().logInWithReadPermissions(thisActivity, Arrays.asList("public_profile", "user_friends"));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                // Building Parameters
                HashMap<String, String> credent = new HashMap<>();
                credent.put("username", mEmail);
                credent.put("password", mPassword);

                Log.d("request!", "starting");
                // getting product details by making HTTP request
                result = httpHandler.checkLogin(LOGIN_URL, credent);
